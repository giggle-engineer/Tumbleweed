...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework 'Pods-Tumbleweed/DDHidLib.framework'
  ...
  install_framework 'Pods-Tumbleweed/PFAboutWindow.framework'
  install_framework 'Pods-Tumbleweed/Regex.framework'
  install_framework 'Pods-Tumbleweed/SPMediaKeyTap.framework'
